...
contract Test_ZivoeYDL_ema is Utility {
    ...
    function test_ZivoeYDL_ema_v2_increasingValues() public {
    ...
    function test_ZivoeYDL_ema_v2_decreasingValues() public {
    ...
    function test_ZivoeYDL_ema_v2_oscillatingValues() public {
    ...
    function test_ZivoeYDL_ema_v2_fuzzTesting(
        uint96 bV,
        uint96 cV,
        uint96 N
    ) public {
