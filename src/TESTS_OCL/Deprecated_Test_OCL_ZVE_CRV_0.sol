...
import "lib/zivoe-core-foundry/src/lockers/OCL/Deprecated_OCL_ZVE_CRV_0.sol";
...
contract Test_OCL_ZVE_CRV_0 is Utility {
    ...
    function xtest_OCL_ZVE_CRV_0_pullMulti_USDC_pullFromLocker() public {
        ...
        assert(god.try_pullMulti(address(DAO), address(OCL_CRV), assets_pull, new bytes[](3)));
